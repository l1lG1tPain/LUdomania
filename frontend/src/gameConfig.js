...
export const PRIZES = {
    // 🦆 Утки (расширено: добавлены новые common, rare и epic призы)
    plush_duck: {
        id: "plush_duck",
    ...
    // 🎮 Неоновый аркад (расширено: добавлены новые common, rare, epic и legendary)
    neon_cat: {
        id: "neon_cat",
        name: "Неоновый кот",
        emoji: "😼",
    ...
    // 🦈 Акулячий сет (расширено: добавлены новые rare, epic и legendary)
    pixel_shark: {
        id: "pixel_shark",
    ...
    // 🫧 Кальянный клуб (расширено: добавлены новые common, rare и epic)
    hookah_flask: {
        id: "hookah_flask",
        name: "Колба кальяна",
        emoji: "🫧",
    ...
    // 🕹 Ретро-сет (расширено: добавлены новые common, rare, epic и legendary)
    retro_console: {
        id: "retro_console",
    ...
    // 🌌 Новая коллекция: Космический сет
    space_rocket: {
        id: "space_rocket",
...
export const MACHINES = [
    // Уровень 0: Только common призы, добавлены новые автоматы с минимум 5 призами каждый (фокус на дешевых, простых)
    {
        id: "basic_claw",
        name: "🧸 Детский кран",
        price: 10,
        ...
        minLevel: 0,
        prizePool: ["plush_duck", "rubber_duck", "arcade_token", "wooden_duck", "pixel_coin", "coal_box", "hookah_hose", "pixel_controller"],
    },
    {
        id: "toy_grabber",
        ...
        minLevel: 0,
        prizePool: ["rubber_duck", "arcade_token", "coal_box", "space_rocket", "candy_bar", "lollipop", "wooden_duck"],
    },
    {
        id: "candy_claw",
        name: "🍬 Конфетный кран",
    ...
    // Уровень 1: Mostly common + немного rare, добавлены новые автоматы
    {
        id: "street_claw",
        ...
        minLevel: 1,
        prizePool: ["plush_duck", "neon_cat", "gold_cube", "hookah_flask", "silver_duck", "neon_dog", "shark_fin", "space_rocket", "candy_bar"],
    },
    {
        id: "neon_grabber",
        ...
        minLevel: 1,
        prizePool: ["neon_cat", "arcade_token", "hookah_flask", "alien_head", "gummy_bear", "wooden_duck", "pixel_coin"],
    },
    {
        id: "hookah_street",
        ...
        minLevel: 1,
        prizePool: ["coal_box", "hookah_flask", "hookah_hose", "smoke_ring", "neon_dog", "candy_bar", "lollipop"],
    },

    // Уровень 2: Больше rare + epic, добавлены новые автоматы
    {
        id: "casino_claw",
        name: "🎰 Казино-кран",
        price: 120,
        ...
        minLevel: 2,
        prizePool: ["neon_cat", "gold_cube", "pixel_shark", "retro_console", "hookah_flask", "silver_duck", "premium_tobacco", "retro_joystick", "alien_head", "gummy_bear"],
    },
    {
        id: "retro_casino",
        name: "🕹 Ретро-казино",
        ...
        minLevel: 2,
        prizePool: ["retro_console", "retro_joystick", "vintage_cartridge", "gold_cube", "black_hole", "neon_cat", "hookah_flask"],
    },
    {
        id: "space_slot",
        ...
        minLevel: 2,
        prizePool: ["space_rocket", "alien_head", "black_hole", "pixel_shark", "premium_tobacco", "gummy_bear", "neon_dog"],
    },

    // Уровень 3: Epic + немного legendary, добавлены новые автоматы
    {
        id: "vip_claw",
        name: "💎 VIP-лапа",
        price: 400,
        ...
        minLevel: 3,
        prizePool: ["golden_duck", "gold_cube", "pixel_shark", "retro_console", "golden_ticket", "diamond_duck", "mega_shark", "vintage_cartridge", "black_hole", "golden_candy"],
    },
    {
        id: "elite_grabber",
        name: "🏆 Элитный захват",
        ...
        minLevel: 3,
        prizePool: ["gold_cube", "pixel_shark", "premium_tobacco", "black_hole", "golden_candy", "platinum_cube", "retro_console"],
    },
    {
        id: "candy_vip",
        name: "🍭 VIP-конфеты",
        ...
        minLevel: 3,
        prizePool: ["gummy_bear", "golden_candy", "golden_duck", "diamond_duck", "vintage_cartridge", "alien_head", "shark_fin"],
    },

    // Уровень 5: Legendary + epic, добавлены новые автоматы
    {
        id: "akula_jackpot",
        name: "🦈 Акулка Слот",
        price: 1000,
        ...
        minLevel: 5,
        prizePool: ["pixel_shark", "ludo_core", "golden_ticket", "platinum_cube", "abyss_pearl", "star_crystal", "legendary_game", "mega_shark"],
    },
    {
        id: "legendary_slot",
        ...
        minLevel: 5,
        prizePool: ["ludo_core", "golden_ticket", "star_crystal", "abyss_pearl", "legendary_game", "platinum_cube", "golden_candy"],
    },
    {
        id: "cosmic_jackpot",
        ...
        minLevel: 5,
        prizePool: ["star_crystal", "black_hole", "ludo_core", "mega_shark", "legendary_game", "golden_ticket", "platinum_cube"],
    },
];
// ==========================================
// 🧩 КОЛЛЕКЦИИ
